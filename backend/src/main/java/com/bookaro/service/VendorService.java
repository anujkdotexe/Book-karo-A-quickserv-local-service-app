...
import com.bookaro.dto.VendorDashboardStats;
...
public class VendorService {
    ...
    public VendorDashboardStats getDashboardStats(Long userId) {
        ...
        List<com.bookaro.model.Service> vendorServices = serviceRepository.findByVendorId(vendor.getId());
        List<Long> serviceIds = vendorServices.stream().map(com.bookaro.model.Service::getId).collect(Collectors.toList());
        ...
        long activeServices = vendorServices.stream().filter(com.bookaro.model.Service::getIsAvailable).count();
     ...
     * Get vendor bookings
     */
    public List<Booking> getVendorBookings(Long userId, String status) {
        Vendor vendor = getVendorByUserId(userId);
        List<com.bookaro.model.Service> vendorServices = serviceRepository.findByVendorId(vendor.getId());
        List<Long> serviceIds = vendorServices.stream().map(com.bookaro.model.Service::getId).collect(Collectors.toList());
     ...
     */
    @Transactional
    public Booking updateBookingStatus(Long userId, Long bookingId, String newStatus) {
        Vendor vendor = getVendorByUserId(userId);
     ...
     * Get vendor services
     */
    public List<com.bookaro.model.Service> getVendorServices(Long userId) {
        Vendor vendor = getVendorByUserId(userId);
     ...
     */
    @Transactional
    public com.bookaro.model.Service createService(Long userId, com.bookaro.model.Service service) {
        Vendor vendor = getVendorByUserId(userId);
        service.setVendor(vendor);
        service.setApprovalStatus(com.bookaro.model.Service.ApprovalStatus.PENDING);
     ...
     */
    @Transactional
    public com.bookaro.model.Service updateService(Long userId, Long serviceId, com.bookaro.model.Service updatedService) {
        Vendor vendor = getVendorByUserId(userId);
        com.bookaro.model.Service service = serviceRepository.findById(serviceId)
     ...
     */
    @Transactional
    public com.bookaro.model.Service toggleServiceAvailability(Long userId, Long serviceId) {
        Vendor vendor = getVendorByUserId(userId);
        com.bookaro.model.Service service = serviceRepository.findById(serviceId)
            .orElseThrow(() -> new RuntimeException("Service not found"));
