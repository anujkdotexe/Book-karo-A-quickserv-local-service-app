...
import com.bookaro.security.CustomUserDetails;
import com.bookaro.service.VendorService;
...
/**
 * Vendor Controller - Endpoints for vendor operations
...
public class VendorController {
    ...
    public ResponseEntity<ApiResponse<List<Booking>>> getBookings(
        ...
        CustomUserDetails userDetails = (CustomUserDetails) authentication.getPrincipal();
        List<Booking> bookings = vendorService.getVendorBookings(userDetails.getId(), status);
    ...
    public ResponseEntity<ApiResponse<Booking>> updateBookingStatus(
            ...
            Authentication authentication) {
        CustomUserDetails userDetails = (CustomUserDetails) authentication.getPrincipal();
        Booking booking = vendorService.updateBookingStatus(userDetails.getId(), id, status);
